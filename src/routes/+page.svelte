...
<main class="flex min-h-[100dvh] flex-col space-y-10">
			...
			<div class="flex justify-between gap-2">
				<div class="flex flex-1 flex-col space-y-1.5">
					<BlurFade
						...
						class="text-xl font-bold tracking-tighter sm:text-2xl xl:text-5xl/none"
						yOffset={8}>Hi, I'm Nikhil 👋</BlurFade
					>
	...
	<section id="projects">
		<div class="w-full space-y-12 py-12">
			...
			<div class="mx-auto grid max-w-[800px] sm:grid-cols-1">
				{#each DATA.openSource as project, id}
					<BlurFade delay={BLUR_FADE_DELAY * 1.5 + id * 0.05}>
						<ProjectCard
							heading={project.heading}
							title={project.title}
	...
	<section id="projects">
		<div class="w-full space-y-12 py-12">
			...
			<div class="mx-auto grid max-w-[800px] sm:grid-cols-1">
				{#each DATA.sideProjects as project, id}
					<BlurFade delay={BLUR_FADE_DELAY * 1.5 + id * 0.05}>
						<ProjectCard
							heading={project.heading}
							title={project.title}
		...
		<div class="grid w-full items-center justify-center gap-4 px-4 py-12 text-center md:px-6">
			<BlurFade delay={BLUR_FADE_DELAY * 2}>
				<div class="space-y-3">
					...
					>
						Want to chat? Feel free to send me a message on
						<a
							href="https://www.linkedin.com/in/nikhil-singhal-0612/"
