					...
					>
						...
						{#if latestPost.image}
							<img
								...
								srcSet={`${base}/blogs/${latestPost.image.replace('.webp', '-588.webp')} 588w, 
           ${base}/blogs/${latestPost.image.replace('.webp', '-1024.webp')} 1024w, 
           ${base}/blogs/${latestPost.image.replace('.webp', '-160.webp')} 160w`}
